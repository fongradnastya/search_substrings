...
TEST_SEARCH_FEW_SUBSTR = [
    ...
    ('ababbababa', ('aba', 'bba'), False, 'first', 4,
     {'aba': (0, 5, 7), 'bba': (3,)}),
    ('ababbababa', ('aba', 'bba'), True, 'first', 4,
     {'aba': (0, 5, 7), 'bba': (3,)}),
    ('ababbababa', ('aba', 'bba'), False, 'last', 4,
     {'aba': (7, 5, 0), 'bba': (3,)}),
    ('ababbababa', ('aba', 'bba'), True, 'last', 4,
     {'aba': (7, 5, 0), 'bba': (3,)}),

    ('ababbababa', ('aba', 'bba'), False, 'first', 3,
     {'aba': (0, 5), 'bba': (3,)}),
    ('ababbababa', ('aba', 'bba'), True, 'first', 2,
     {'aba': (0,), 'bba': (3,)}),
    ('ababbababa', ('aba', 'bba'), False, 'last', 1,
     {'aba': (7,), 'bba': None}),
    ('ababbababa', ('aba', 'bba'), True, 'last', 10,
     {'aba': (7, 5, 0), 'bba': (3,)}),
]
